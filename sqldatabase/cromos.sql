...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 05-06-2021 a las 03:58:46
...
INSERT INTO `coleccion` (`IdColeccion`, `Estado`, `Nombre`) VALUES
(1, 'Inactivo', 'COLECCION1');
...
INSERT INTO `socio` (`IdSocio`, `Saldo`) VALUES
(2, 0);
...
--
ALTER TABLE `coleccion`
  MODIFY `IdColeccion` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de la tabla `cromo`
--
ALTER TABLE `cromo`
  MODIFY `IdCromo` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de la tabla `socio`
--
ALTER TABLE `socio`
  MODIFY `IdSocio` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
